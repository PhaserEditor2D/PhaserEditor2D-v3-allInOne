...
echo Name=Phaser Editor 2D All In One v3 >> phasereditor2d-PhaserEditor2D.desktop
...
echo Exec=$DIR/PhaserEditor2D-allInOne >> phasereditor2d-PhaserEditor2D.desktop
